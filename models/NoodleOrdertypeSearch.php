...
/**
 * NoodleOrdertypeSearch represents the model behind the search form about `frontend\modules\noodlepos\models\NoodleOrdertype`.
 */
class NoodleOrdertypeSearch extends NoodleOrdertype
{
    /**
     * @inheritdoc
     */
