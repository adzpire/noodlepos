...
/**
 * NoodleOrderdetailSearch represents the model behind the search form about `frontend\modules\noodlepos\models\NoodleOrderdetail`.
 */
class NoodleOrderdetailSearch extends NoodleOrderdetail
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'orderid', 'menuid', 'tableid', 'price'], 'integer'],
            [['noodletype', 'addons', 'note'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'noodletype', $this->noodletype])
            ->andFilterWhere(['like', 'addons', $this->addons])
