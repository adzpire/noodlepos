...
/**
 * NoodleOrderSearch represents the model behind the search form about `frontend\modules\noodlepos\models\NoodleOrder`.
 */
class NoodleOrderSearch extends NoodleOrder
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'userid', 'status', 'total'], 'integer'],
            [['datetime'], 'safe'],
        ];
    }
