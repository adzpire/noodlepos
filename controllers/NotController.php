...
use frontend\modules\noodlepos\models\NoodleOrdertypeSearch;
...
/**
 * NotController implements the CRUD actions for NoodleOrdertype model.
 */
class NotController extends Controller
{
    ...
    /**
     * Lists all NoodleOrdertype models.
     * @return mixed
     */
    public function actionIndex()
    {
		 
		 Yii::$app->view->title = 'Noodle Ordertypes'.' - '.Yii::t('itinfo/app', Yii::$app->controller->module->params['title']);
		 
        $searchModel = new NoodleOrdertypeSearch();
    ...
    /**
     * Displays a single NoodleOrdertype model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new NoodleOrdertype model.
    ...
    /**
     * Updates an existing NoodleOrdertype model.
    ...
    public function actionUpdate($id)
    {
		 ...
		 Yii::$app->view->title = 'Update Noodle Ordertype: ' . $model->name.' - '.Yii::t('itinfo/app', Yii::$app->controller->module->params['title']);
    ...
    /**
     * Deletes an existing NoodleOrdertype model.
    ...
    /**
     * Finds the NoodleOrdertype model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return NoodleOrdertype the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = NoodleOrdertype::findOne($id)) !== null) {
            return $model;
        } else {
