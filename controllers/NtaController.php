...
/**
 * NtaController implements the CRUD actions for NoodleTable model.
 */
class NtaController extends Controller
{
    ...
    /**
     * Lists all NoodleTable models.
     * @return mixed
     */
    public function actionIndex()
    {
		 
		 Yii::$app->view->title = 'Noodle Tables'.' - '.Yii::t('itinfo/app', Yii::$app->controller->module->params['title']);
		 
        $searchModel = new NoodleTableSearch();
    ...
    /**
     * Displays a single NoodleTable model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new NoodleTable model.
    ...
    /**
     * Updates an existing NoodleTable model.
    ...
    public function actionUpdate($id)
    {
		 ...
		 Yii::$app->view->title = 'Update Noodle Table: ' . $model->name.' - '.Yii::t('itinfo/app', Yii::$app->controller->module->params['title']);
    ...
    /**
     * Deletes an existing NoodleTable model.
    ...
    /**
     * Finds the NoodleTable model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return NoodleTable the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = NoodleTable::findOne($id)) !== null) {
            return $model;
        } else {
